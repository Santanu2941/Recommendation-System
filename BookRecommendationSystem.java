...
public class BookRecommendationSystem {
    ...
    static {
        ...
        bookSimilarities.put("The Adventures of Huckleberry Finn", Arrays.asList("The Hobbit", "The Silmarillion", "The Chronicles of Narnia"));
        bookSimilarities.put("Middlemarch", Arrays.asList("Divergent", "Maze Runner", "The Selection"));
